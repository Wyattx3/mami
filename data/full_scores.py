"""
Full Scoring Tables for All 145 Roles
Generated automatically from themes.py
"""

# MBTI Scores (1-10) for each role
MBTI_SCORES = {
    'Aquaman': {
    ...
    'Black Widow': {
        'ISTP': 10, 'ESTP': 9, 'INTJ': 8, 'ENTJ': 8,
        'INTP': 6, 'ENTP': 6, 'INFJ': 2, 'INFP': 2,
        'ENFJ': 2, 'ENFP': 6, 'ISTJ': 6, 'ISFJ': 6,
        'ESTJ': 6, 'ESFJ': 2, 'ISFP': 2, 'ESFP': 2
    },
    'Bobby Soxer': {
        'ESFP': 10, 'ENFP': 9, 'ESTP': 8, 'ENTP': 8,
        'INTJ': 2, 'INTP': 2, 'ENTJ': 6, 'INFJ': 2,
    ...
    'Iron Man': {
        'ENTP': 10, 'ENTJ': 9, 'INTP': 8, 'INTJ': 8,
        'INFJ': 6, 'INFP': 2, 'ENFJ': 6, 'ENFP': 6,
        'ISTJ': 2, 'ISFJ': 2, 'ESTJ': 2, 'ESFJ': 2,
        'ISTP': 6, 'ISFP': 2, 'ESTP': 2, 'ESFP': 2
    },
    'Jude Bellingham': {
        'ENFP': 10, 'ESFP': 9, 'ENTJ': 8, 'ESTJ': 8,
        'INTJ': 2, 'INTP': 2, 'ENTP': 6, 'INFJ': 6,
        'INFP': 2, 'ENFJ': 6, 'ISTJ': 2, 'ISFJ': 6,
        'ESFJ': 6, 'ISTP': 6, 'ISFP': 2, 'ESTP': 6
    },
    'Khin Maung Toe': {
        'ISFJ': 10, 'ISTJ': 9, 'INFJ': 8, 'INTJ': 8,
        'INTP': 6, 'ENTJ': 2, 'ENTP': 2, 'INFP': 6,
    ...
    'Scarlet Witch': {
        'INFP': 10, 'INFJ': 9, 'ENFP': 8, 'ENFJ': 8,
        'INTJ': 2, 'INTP': 6, 'ENTJ': 2, 'ENTP': 6,
    ...
    'Vision': {
        'INTJ': 10, 'INTP': 9, 'INFJ': 8, 'INFP': 8,
        'ENTJ': 2, 'ENTP': 6, 'ENFJ': 6, 'ENFP': 6,
        'ISTJ': 6, 'ISFJ': 6, 'ESTJ': 2, 'ESFJ': 2,
        'ISTP': 6, 'ISFP': 6, 'ESTP': 2, 'ESFP': 2
    },
    'Wine Su Khaing Thein': {
        'ISFP': 10, 'INFP': 9, 'ISFJ': 8, 'INFJ': 8,
        'INTJ': 6, 'INTP': 6, 'ENTJ': 2, 'ENTP': 2,
        'ENFJ': 6, 'ENFP': 6, 'ISTJ': 6, 'ESTJ': 2,
        'ESFJ': 6, 'ISTP': 6, 'ESTP': 2, 'ESFP': 2
    },
    ...
    'စာမလုပ်သူ': {
        'ESTP': 10, 'ESFP': 9, 'ISTP': 8, 'ISFP': 8,
        'INTJ': 2, 'INTP': 2, 'ENTJ': 2, 'ENTP': 6,
        'INFJ': 2, 'INFP': 6, 'ENFJ': 2, 'ENFP': 6,
        'ISTJ': 6, 'ISFJ': 6, 'ESTJ': 2, 'ESFJ': 2
    },
    'စားတော်ချက်': {
        'ISFP': 10, 'ESFP': 9, 'INFP': 8, 'ENFP': 8,
        'INTJ': 2, 'INTP': 2, 'ENTJ': 2, 'ENTP': 6,
        'INFJ': 6, 'ENFJ': 6, 'ISTJ': 2, 'ISFJ': 6,
        'ESTJ': 2, 'ESFJ': 6, 'ISTP': 6, 'ESTP': 6
    },
    ...
    'ဖော်ဖော်ရွေရွေရှိသူ': {
        'ENFP': 10, 'ESFP': 9, 'ENFJ': 8, 'ESFJ': 8,
        'INTJ': 2, 'INTP': 2, 'ENTJ': 6, 'ENTP': 6,
        'INFJ': 6, 'INFP': 6, 'ISTJ': 2, 'ISFJ': 6,
        'ESTJ': 6, 'ISTP': 2, 'ISFP': 6, 'ESTP': 6
    },
    'ဘဏ္ဍာရေးဝန်ကြီး': {
        'INTJ': 10, 'ENTJ': 9, 'ISTJ': 8, 'ESTJ': 8,
        'INTP': 2, 'ENTP': 2, 'INFJ': 6, 'INFP': 2,
        'ENFJ': 6, 'ENFP': 2, 'ISFJ': 6, 'ESFJ': 6,
        'ISTP': 6, 'ISFP': 2, 'ESTP': 2, 'ESFP': 2
    },
    'ဘုန်းကြီး': {
        'INFJ': 10, 'INFP': 9, 'ENFJ': 8, 'ISFJ': 8,
        'INTJ': 6, 'INTP': 6, 'ENTJ': 2, 'ENTP': 2,
        'ENFP': 6, 'ISTJ': 2, 'ESTJ': 2, 'ESFJ': 6,
        'ISTP': 2, 'ISFP': 6, 'ESTP': 2, 'ESFP': 2
    },
    'ဘုရင်': {
        'ENTJ': 10, 'ENFJ': 9, 'ESTJ': 8, 'ENTP': 8,
        'INTJ': 6, 'INTP': 2, 'INFJ': 6, 'INFP': 2,
    ...
    'အကုသိုလ်': {
        ...
        'ENFJ': 2, 'ENFP': 6, 'ISTJ': 2, 'ISFJ': 2,
        'ESTJ': 2, 'ESFJ': 2, 'ISFP': 6, 'ESFP': 6
    },
    'အကြံပေး': {
...
# Zodiac Scores (1-10) for each role
ZODIAC_SCORES = {
    'Aquaman': {
    ...
    'ဘုန်းကြီး': {
        'Libra': 10, 'Pisces': 9, 'Cancer': 8, 'Taurus': 7,
        'Aries': 5, 'Gemini': 5, 'Leo': 5, 'Virgo': 5,
        'Scorpio': 4, 'Sagittarius': 4, 'Capricorn': 2, 'Aquarius': 2
    },
    'ဘုရင်': {
        'Leo': 10, 'Aries': 9, 'Capricorn': 8, 'Scorpio': 7,
        'Taurus': 5, 'Gemini': 5, 'Cancer': 5, 'Virgo': 5,
